...
class BeastPlannernew : public ompl::control::RRT {
  public:

    /** \brief Constructor */
    BeastPlannernew(const SpaceInformationPtr &si, const FileMap &params) :
            ompl::control::RRT(si), newsampler_(NULL), params(params) {

        whichSearch = params.stringVal("WhichSearch");

        std::string plannerName = "BeastPlannernew_" + whichSearch;
        setName(plannerName);

        Planner::declareParam<double>("state_radius", this, &BeastPlannernew::ignoreSetterDouble, &BeastPlannernew::getStateRadius);
        Planner::declareParam<unsigned int>("prm_size", this, &BeastPlannernew::ignoreSetterUnsigedInt, &BeastPlannernew::getPRMSize);
        Planner::declareParam<unsigned int>("num_prm_edges", this, &BeastPlannernew::ignoreSetterUnsigedInt, &BeastPlannernew::getNumPRMEdges);

        Planner::declareParam<double>("valid_edge_distribution_alpha", this, &BeastPlannernew::ignoreSetterDouble, &BeastPlannernew::getValidEdgeDistributionAlpha);
        Planner::declareParam<double>("valid_edge_distribution_beta", this, &BeastPlannernew::ignoreSetterDouble, &BeastPlannernew::getValidEdgeDistributionBeta);
        Planner::declareParam<double>("invalid_edge_distribution_alpha", this, &BeastPlannernew::ignoreSetterDouble, &BeastPlannernew::getInvalidEdgeDistributionAlpha);
        Planner::declareParam<double>("invalid_edge_distribution_beta", this, &BeastPlannernew::ignoreSetterDouble, &BeastPlannernew::getInvalidEdgeDistributionBeta);
        ...
        Planner::declareParam<double>("sampler_initialization_time", this, &BeastPlannernew::ignoreSetterDouble, &BeastPlannernew::getSamplerInitializationTime);
    }

    virtual ~BeastPlannernew() {}
