...
#include "../samplers/beats_sampler.hpp"
#include <limits>
...
public:
    ...
    BeatsPlanner(const SpaceInformationPtr& si, const FileMap& params) :
        ...
        std::string plannerName = "BeatsPlanner_" + whichSearch;
        setName(plannerName);

        Planner::declareParam<double>("state_radius",
                                      this,
                                      &BeatsPlanner::ignoreSetterDouble,
                                      &BeatsPlanner::getStateRadius);
        Planner::declareParam<unsigned int>("prm_size",
                                            this,
                                            &BeatsPlanner::ignoreSetterUnsigedInt,
                                            &BeatsPlanner::getPRMSize);
        Planner::declareParam<unsigned int>("num_prm_edges",
                                            this,
                                            &BeatsPlanner::ignoreSetterUnsigedInt,
                                            &BeatsPlanner::getNumPRMEdges);

        Planner::declareParam<double>("valid_edge_distribution_alpha",
                                      this,
                                      &BeatsPlanner::ignoreSetterDouble,
                                      &BeatsPlanner::getValidEdgeDistributionAlpha);
        Planner::declareParam<double>("valid_edge_distribution_beta",
                                      this,
                                      &BeatsPlanner::ignoreSetterDouble,
                                      &BeatsPlanner::getValidEdgeDistributionBeta);
        Planner::declareParam<double>("invalid_edge_distribution_alpha",
                                      this,
                                      &BeatsPlanner::ignoreSetterDouble,
                                      &BeatsPlanner::getInvalidEdgeDistributionAlpha);
        Planner::declareParam<double>("invalid_edge_distribution_beta",
                                      this,
                                      &BeatsPlanner::ignoreSetterDouble,
                                      &BeatsPlanner::getInvalidEdgeDistributionBeta);
        ...
        Planner::declareParam<double>("sampler_initialization_time",
                                      this,
                                      &BeatsPlanner::ignoreSetterDouble,
                                      &BeatsPlanner::getSamplerInitializationTime);
    }

    virtual ~BeatsPlanner() {}
    ...
    virtual base::PlannerStatus solve(const base::PlannerTerminationCondition& terminationCondition) {
        ...
        if (!newsampler_) {
            ...
            newsampler_ = new ompl::base::BeatsSampler(
                (ompl::base::SpaceInformation*) siC_, pdef_->getStartState(0),
                pdef_->getGoal(),
                goal_s,
                params);

            // Create abstraction and connect nodes
