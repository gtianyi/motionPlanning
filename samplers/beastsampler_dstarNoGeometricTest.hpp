...
class BeastSampler_dstarNoGeometricTest : public ompl::base::BeastSamplerBase {
  public:
    BeastSampler_dstarNoGeometricTest(ompl::base::SpaceInformation *base, ompl::base::State *start, const ompl::base::GoalPtr &goal,
                                      base::GoalSampleableRegion *gsr, const FileMap &params) : BeastSamplerBase(base, start, goal, gsr, params), addedGoalEdge(false) {}

    ~BeastSampler_dstarNoGeometricTest() {}
