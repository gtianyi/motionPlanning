...
class AnytimeBeastSampler_Dis : public ompl::base::UniformValidStateSampler {
    typedef AbstractVertex Vertex;
    typedef AbstractEdge Edge;
  public:
    AnytimeBeastSampler_Dis(ompl::base::SpaceInformation *base, ompl::base::State *start, const ompl::base::GoalPtr &goal,
    ...
    virtual ~AnytimeBeastSampler_Dis() {
        delete abstraction;
        delete dijkstra;
        delete dstar;
    }
