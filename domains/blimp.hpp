...
BenchmarkData blimpBenchmark(const FileMap &params) {
	...
	// set the start & goal states
        blimpPtr->addStartState(blimp->getFullStateFromGeometricComponent(start));
	...
	blimp->setRobotMesh("../models/" + agentMesh);
	blimp->setEnvironmentMesh("../models/" + environmentMesh);
